...
let s:N3 = [ '#585858' , '#eeeeee' , 255 , 24  ] " StatusLine
...
let g:airline#themes#papercolor#palette.normal_modified = {
      \ 'airline_c': [ '#eeeeee' , '#eeeeee' , 255 , 24 , '' ] ,
      \ }
...
let s:I3 = [ '#585858' , '#eeeeee' , 255 , 24  ] " StatusLine
...
let g:airline#themes#papercolor#palette.visual_modified = {
      \ 'airline_c': [ '#e4e4e4', '#eeeeee', 254, 24  ] ,
      \ }

" Inactive:
let s:IA = [ '#585858' , '#eeeeee' , 240 , 254 , '' ]
